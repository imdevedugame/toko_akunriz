  ...
  const timeline = [
    {
      year: "2020",
      title: "Berdiri",
      description: "Vyloz Premium Zone didirikan dengan visi menyediakan akun premium berkualitas tinggi.",
      icon: Building,
      color: "from-blue-500 to-blue-600",
    },
    {
      ...
      <div className="relative container mx-auto px-4 py-8">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Melihat kembali perjalanan dan milestone penting dalam pengembangan Vyloz Premium Zone
            </p>
          </div>
