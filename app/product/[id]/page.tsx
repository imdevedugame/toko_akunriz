          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Platform terpercaya untuk membeli akun premium dengan harga terjangkau dan kualitas terbaik.
              </p>
            ...
            {/* Payment & Security */}
            <div>
              <h4 className="text-lg font-semibold mb-4">Keamanan & Pembayaran</h4>
              <div className="space-y-3">
