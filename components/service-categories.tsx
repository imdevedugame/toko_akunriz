            ...
            <CardContent className="py-12 px-8 relative z-10">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold px-8 py-4 text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
                  >
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 border-amber-500 text-amber-400 hover:bg-amber-500 hover:text-white bg-transparent font-semibold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-300"
                  >
                    📞 Hubungi Kami
                  </Button>
                </div>
