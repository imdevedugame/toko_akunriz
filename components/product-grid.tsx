...
import { Star, ShoppingCart, Eye, Heart, Zap, Crown, TrendingUp, Shield, Clock, Package, Sparkles } from "lucide-react"
            ...
            <CardContent className="p-0">
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50">
                ...
                {user?.role === "reseller" && getDiscountPercentage(product) > 0 && (
                  <div className="absolute top-2 sm:top-3 lg:top-4 right-2 sm:right-3 lg:right-4">
                    <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold px-2 py-1 sm:px-3 sm:py-1 lg:px-4 lg:py-2 shadow-md sm:shadow-lg lg:shadow-xl text-xs sm:text-sm animate-bounce">
                      <Sparkles className="h-2 w-2 sm:h-3 sm:w-3 mr-1" />-{getDiscountPercentage(product)}%
                    </Badge>
                  </div>
                )}
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-2 sm:gap-4 opacity-0 sm:group-hover:opacity-100 transition-all duration-300 sm:duration-500 transform group-hover:scale-100 scale-90 hidden sm:flex">
                  ...
                  >
                    <Heart
                      className={`h-3 w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5 ${favorites.has(product.id) ? "fill-current" : ""}`}
                    />
                  </Button>
                </div>
              </div>
              ...
              <div className="p-3 sm:p-4 lg:p-6 relative">
                ...
                <div className="flex items-center justify-between mb-2 sm:mb-3 lg:mb-4">
                  <Badge
                    className={`bg-gradient-to-r ${getCategoryColor(product.category_name)} text-white font-semibold px-2 py-1 sm:px-3 sm:py-1 lg:px-4 lg:py-2 shadow-md sm:shadow-lg text-xs sm:text-sm`}
                  >
                ...
                {/* Product Name */}
                <h3 className="font-bold text-sm sm:text-base lg:text-xl mb-2 sm:mb-3 line-clamp-2 group-hover:text-amber-700 transition-colors leading-tight">
                  {product.name}
                </h3>
                ...
                <div className="mb-3 sm:mb-4 lg:mb-6 p-2 sm:p-3 lg:p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg sm:rounded-xl">
                  <div className="flex items-end justify-between">
                    <div>
                      <div className="text-lg sm:text-xl lg:text-3xl font-bold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
                ...
                <Button
                  asChild
                  className={`w-full font-bold text-xs sm:text-sm lg:text-lg py-2 sm:py-3 lg:py-4 transition-all duration-300 sm:duration-500 transform hover:scale-105 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl ${
                    product.stock === 0
